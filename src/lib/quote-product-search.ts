...
export const QUOTE_PRODUCT_SELECT =
  "id, product_name, model_name, sku, supplier, category, brand, color, product_option, size, sale_price, purchase_price, stock_quantity, stock_yangjae, stock_uiwang, reserved_quantity";
